...
//the following class was taken from a tutorial by Rob Camick at 
//https://tips4java.wordpress.com/2013/06/09/motion-using-the-keyboard/
/*  the code is provided for  "free to use and/or modify and/or distribute any or all code posted on 
 * the Java Tips Weblog without restriction"
 * 
 */
public class KeyboardAnimation implements ActionListener
{
	...
	public void  addPaddle(PongPaddle paddle)
	{
		this.paddle = paddle; 
	}
	...
	*/
	...
	public void addPongGameManager(PongGameManager pgm)
	{
		this.pgm = pgm; 
	}
	private void moveComponent()
	{
		int componentWidth = pgm.paddleWidth;
		int componentHeight = pgm.paddleLength;

		//Dimension parentSize = component.getParent().getSize();
		int parentWidth  = PongGameManager.boardLength;
		int parentHeight = PongGameManager.boardHeight;
